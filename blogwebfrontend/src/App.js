...
import NavPan from './Component/Navigation Pan/NavPan';
    ...
    <Router>   
      <div className='main'>
          ...
          <Routes>
            ...
            {['/blogs','/dashBoard/addBlogs','/dashBoard/approvedBlogs','/dashBoard/pendingBlogs','/dashBoard/rejectedBlogs','/admin/:email/approvedBlogs','/admin/:email/pendingBlogs','/admin/:email/rejectedBlogs','/admin/approvedBlogs','/admin/pendingBlogs','/admin/rejectedBlogs'].map((path,index) => 
          ...
          <Footer text={"Designed & Maintained by Mr. Himanshu Seth.All right reserved @2022"} />
      </div>
    </Router>
  );
  }
